...
@section('title', 'Nieuw galerij item')
...
@section('content')
    ...
    <div class="mb-10">
        ...
        <p class="text-roze-dark text-xs tracking-[0.3em] uppercase font-semibold mb-2">Nieuw item</p>
        <h1 class="font-serif text-3xl font-bold text-zwart">Galerij item toevoegen</h1>
    </div>
        ...
        <form method="POST" action="{{ route('admin.gallery.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required
                       ...
                       placeholder="Bijv. Cryolipolyse buik behandeling">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                          class="w-full px-5 py-3.5 rounded-xl border border-zwart/10 bg-creme/50 text-zwart placeholder:text-zwart/30 focus:outline-none focus:border-roze-dark focus:ring-1 focus:ring-roze-dark transition-colors text-sm"
                          placeholder="Korte beschrijving van de behandeling en het resultaat">{{ old('description') }}</textarea>
            ...
            <div class="flex items-center gap-2.5">
                ...
                <label for="is_published" class="text-sm text-zwart/60">Direct publiceren</label>
            </div>
